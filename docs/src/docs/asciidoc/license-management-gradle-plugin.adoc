...
[subs="attributes"]
----
octopus-license-management.version={version-label}
----
...
buildscript {
    dependencies {
        classpath "org.octopusden.octopus.license:org.octopusden.octopus.license-management:${project.findProperty('octopus-license-management.version') ?: '{version-label}'}"
     }
}
