...
[subs="attributes"]
----
octopus-license-gradle-plugin.version={version-label}
----
...
buildscript {
    dependencies {
        classpath "org.octopusden.octopus.license:org.octopusden.octopus.license-management:${project.findProperty('octopus-license-gradle-plugin.version') ?: '{version-label}'}"
     }
}
